...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "MEMORIA_IA_VERSION", "\"v1.0.0-rc7+cognitive-v1+restart1\"")
        buildConfigField("String", "MEMORIA_IA_COMMIT", "\"2d345463769d5770eb8732e3ba26f0d7b0f6465f\"")
